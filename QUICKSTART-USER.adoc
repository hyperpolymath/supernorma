...
// Replace supernorma, Supernorma — See README.adoc for details., just run, Supernorma started successfully. with actuals
= supernorma — Quick Start for Users
:toc:
:toclevels: 2

== What is supernorma?

Supernorma — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./supernorma-portable
----
...
[source]
----
Supernorma started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/supernorma/wiki
