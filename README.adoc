...
:experimental:
:url-github: https://github.com/hyperpolymath/SuperNorma
:url-gitlab: https://gitlab.com/hyperpolymath/SuperNorma
:url-bitbucket: https://bitbucket.org/hyperpolymath/SuperNorma
:url-codeberg: https://codeberg.org/hyperpolymath/SuperNorma

Super normalized data structures
...
SuperNorma is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
