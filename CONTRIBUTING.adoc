...
git clone https://github.com/hyperpolymath/supernorma.git cd supernorma
...
toolbox create supernorma-dev toolbox enter supernorma-dev # Install
...
supernorma/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
